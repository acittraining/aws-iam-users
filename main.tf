...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
## output.tf
output "sammy_user_name" {
  value = aws_iam_user.sammy.name
}

output "blossom_user_name" {
  value = aws_iam_user.blossom.name
}

output "SOC_group_name" {
  value = aws_iam_group.SOC.name
}

output "CNOC_group_name" {
  value = aws_iam_group.CNOC.name
}
